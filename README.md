...
- **产品版** http://127.0.0.1:8765/flow.html — 一份人物料、多场相遇；答完四问一键生成，下载正面/背面 PNG、双面 PDF（90×54mm）和 vCard（手机通讯录）
...
- 90×54mm 双面预览；工作室可打印，产品版可下正面/背面 PNG（300dpi）、双面 PDF 和 vCard
